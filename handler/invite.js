module.exports = (bot) => {
        ...
        bot.on("guildMemberAdd", (member) => {
            ...
            const db = new Database("./Servers/" + member.guild.id, "Invites"),
                ...
                settings = new Database("./Servers/" + member.guild.id, "Settings").get("settings") || {};
            var guild = member.guild,
                fake = (Date.now() - member.createdAt) / (1000 * 60 * 60 * 24) <= 3 ? true : false,
                channel = guild.channels.cache.get(bot.ayar.Genel.invitelog);
        ...
        bot.on("guildMemberRemove", (member) => {
            ...
            var total = 0,
                ...
                regular = 0,
                fakecount = 0,
                channel = member.guild.channels.cache.get(bot.ayar.Genel.invitelog),
                content = settings.leaveMessage ? settings.leaveMessage : `${member} is left the server.`,
    ...
    //https://github.com/aloshai/invite-manager